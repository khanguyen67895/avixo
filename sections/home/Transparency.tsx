        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-0">
            ...
            <p className="text-white text-sm mb-12 leading-5">
              {t("Tại AVIXO, chúng tôi cam kết cung cấp dữ liệu xác thực, được kiểm chứng qua các nền tảng")} <br /> {t("Myfxbook công khai. Mọi thuật toán đều dựa trên logic toán học, không phải phỏng đoán.")}
            </p>
